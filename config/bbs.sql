/*
 ...
 Source Schema         : nodebbs

 Target Server Type    : MySQL
 Target Server Version : 80013
 File Encoding         : 65001

 Date: 09/04/2019 21:11:20
*/
...
CREATE TABLE `answer` (
  ...
  `pid` int(11) NOT NULL COMMENT '主题ID',
  ...
  `afavor` int(11) unsigned zerofill DEFAULT '00000000000' COMMENT '点赞',
  `parent_aid` int(11) NOT NULL COMMENT '回复父ID',
  PRIMARY KEY (`aid`),
  KEY `pid` (`pid`),
  KEY `uid` (`uid`)
...
-- ----------------------------
BEGIN;
INSERT INTO `answer` VALUES (1, 1, 10002, '<p>2222</p>', '2019-04-03 22:51:44', 00000000000, 0);
INSERT INTO `answer` VALUES (2, 1, 10002, '<p>123</p>', '2019-04-03 22:51:54', 00000000000, 0);
INSERT INTO `answer` VALUES (3, 1, 10002, '<p>12323</p>', '2019-04-03 22:52:13', 00000000000, 0);
INSERT INTO `answer` VALUES (4, 2, 10002, '<p>212331</p>', '2019-04-06 00:14:20', 00000000000, 0);
INSERT INTO `answer` VALUES (5, 2, 10002, '<p>5555</p>', '2019-04-06 00:14:29', 00000000000, 0);
COMMIT;
...
) ENGINE=InnoDB AUTO_INCREMENT=659005 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='地区表';
...
INSERT INTO `area` VALUES (120225, '蓟县', 120200);
...
INSERT INTO `area` VALUES (139001, '定州市', 139000);
INSERT INTO `area` VALUES (139002, '辛集市', 139000);
...
INSERT INTO `area` VALUES (150601, '市辖区', 150600);
...
INSERT INTO `area` VALUES (410211, '金明区', 410200);
...
INSERT INTO `area` VALUES (441900, '东莞市', 441900);
INSERT INTO `area` VALUES (442000, '中山市', 442000);
...
INSERT INTO `area` VALUES (500234, '开县', 500200);
...
INSERT INTO `area` VALUES (520501, '市辖区', 520500);
...
INSERT INTO `area` VALUES (520601, '市辖区', 520600);
...
CREATE TABLE `city` (
  ...
  PRIMARY KEY (`code`),
  KEY `parent_code` (`parent_code`)
) ENGINE=InnoDB AUTO_INCREMENT=659001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='城市表';
...
INSERT INTO `city` VALUES (139000, '省直辖县级行政区划', 130000);
...
INSERT INTO `city` VALUES (310100, '市辖区', 310000);
INSERT INTO `city` VALUES (310200, '县', 310000);
...
INSERT INTO `city` VALUES (419000, '省直辖县级行政区划', 410000);
...
INSERT INTO `city` VALUES (429000, '省直辖县级行政区划', 420000);
...
INSERT INTO `city` VALUES (469000, '省直辖县级行政区划', 460000);
INSERT INTO `city` VALUES (500100, '市辖区', 500000);
INSERT INTO `city` VALUES (500200, '县', 500000);
...
INSERT INTO `city` VALUES (659000, '自治区直辖县级行政区划', 650000);
COMMIT;
...
CREATE TABLE `post` (
  ...
  `type_id` int(11) DEFAULT NULL COMMENT '帖子类型ID',
  PRIMARY KEY (`pid`),
  KEY `uid` (`uid`)
...
-- ----------------------------
BEGIN;
INSERT INTO `post` VALUES (1, '1111', '2019-04-03 22:51:25', '2019-04-03 22:51:25', 10002, '1111', NULL, '<p>1111</p>', 00000000005, 00000000003, 00000000000, NULL);
INSERT INTO `post` VALUES (2, '123', '2019-04-06 00:12:04', '2019-04-06 00:12:04', 10002, '12344', NULL, '<p><img alt=\"WechatIMG15.jpeg\" src=\"data:image/jpeg;base64,\" width=\"640\" height=\"640\"><br></p>', 00000000008, 00000000002, 00000000000, NULL);
COMMIT;
...
CREATE TABLE `province` (
  ...
  `name` varchar(32) NOT NULL,
  PRIMARY KEY (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=820001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='省份表';
...
CREATE TABLE `topic_type` (
  ...
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '话题类型',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '话题备注',
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  `province_code` varbinary(255) DEFAULT NULL COMMENT '省份代码',
  `area_code` varchar(255) DEFAULT NULL COMMENT '区县代码',
...
-- ----------------------------
BEGIN;
INSERT INTO `user` VALUES (10001, 'test@qq.com', 'test', '123456', '2018-06-03 15:32:33', '0', '男', '杭州', 'HELLO', NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES (10002, '111@tt.com', '111', 'e10adc3949ba59abbe56e057f20f883e', '2019-04-03 22:47:59', NULL, '女', NULL, '1111', 'public/images/ue/3.jpg', '福建省', NULL, 0x333530303030, NULL, NULL);
INSERT INTO `user` VALUES (10003, 'test2@tt.com', 'test2', 'e10adc3949ba59abbe56e057f20f883e', '2019-04-06 00:17:47', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
COMMIT;
